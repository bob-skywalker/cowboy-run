...
class PhysicsHelper{
    static func addPhysicsBody(to sprite: SKSpriteNode, with name: String){
        ...
        case GameConstants.StringConstants.coinName, GameConstants.StringConstants.powerUpName, _ where GameConstants.StringConstants.superCoinName.contains(name):
